                ...
                <div className="space-y-2.5 border-t border-zinc-100 dark:border-zinc-800 pt-2.5">
                    ...
                    <div className="flex items-end justify-between gap-4">
                        ...
                        <div className="shrink-0">
                            <button disabled={loading} onClick={handleBookEvent} className="bg-zinc-950 text-white dark:bg-white dark:text-black text-xs font-bold py-2 px-3.5 rounded-xl shadow-xs hover:bg-zinc-800 active:scale-[0.98] transition-all whitespace-nowrap flex items-center gap-1 disabled:opacity-50">
                                Book Now
