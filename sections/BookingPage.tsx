        ...
        <div className="min-h-screen w-full pt-5 p-4 font-manrope bg-zinc-50/50">
            <header className="flex items-center justify-between w-full border-b border-black/5 pb-4">
                <div className="flex flex-col items-start md:items-end w-full">
                    <h1 className="text-xl tracking-tight font-black text-black">My Bookings</h1>
            ...
            <div className="w-full mt-5 flex items-center justify-between gap-4">
                <div className="bg-black text-white text-xs font-medium px-4 py-1.5 rounded-lg select-none shadow-xs shrink-0">
                    All Bookings <span className="font-mono ml-1 text-zinc-400 font-bold">{userBookings.length}</span>
                </div>
                <a
                    href="/dashboard?tab=events"
                    className="flex items-center gap-1 text-xs font-bold text-zinc-900 hover:text-black bg-white hover:bg-zinc-100 border border-zinc-200/80 px-3 py-1.5 rounded-lg transition-all"
                >
                    <Plus size={14} />
